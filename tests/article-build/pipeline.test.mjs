...
import { loadReferenceCatalog } from '../../skills/article-build/referenceCatalog.mjs';
import { renderMarkdown } from '../../skills/article-build/renderHtml.mjs';
import { runArticleBuildSkill } from '../../skills/article-build/skill.mjs';
import { validateSvgFile } from '../../skills/article-build/svgValidation.mjs';

const fixtureRoot = resolve('tests/article-build/fixtures/article-template');
