...
| [DS012](specsLoader.html?spec=DS012-webskel-ui-engineering.md) | WebSkel UI Engineering | [[status:implemented]] | webskel-ui-engineering | Defines WebSkel as the MVM UI framework for Ploinky agents and Explorer-hosted plugins, with declarative actions, templates, lifecycle, and reusable components. |
